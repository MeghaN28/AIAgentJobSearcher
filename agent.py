...
from recommendedjobs import recommend_jobs
...
prompt = ChatPromptTemplate.from_messages([
    ("system", "You are TARS, a sarcastic and brilliant AI job recommender. Your job is to suggest the top remote tech jobs based on a user's resume or profile. Make clever remarks, but always be helpful."),
